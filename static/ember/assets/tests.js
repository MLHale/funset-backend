...
define('pathway-viz-frontend/tests/helpers/resolver', ['exports', 'pathway-viz-frontend/resolver', 'pathway-viz-frontend/config/environment'], function (exports, _resolver, _environment) {
  'use strict';
...
define('pathway-viz-frontend/tests/test-helper', ['pathway-viz-frontend/tests/helpers/resolver', 'ember-qunit', 'ember-cli-qunit'], function (_resolver, _emberQunit, _emberCliQunit) {
  'use strict';
