...
define("pathway-viz-frontend/instance-initializers/ember-data", ["exports", "ember-data/instance-initializers/initialize-store-service"], function (exports, _initializeStoreService) {
  "use strict";
...
define("pathway-viz-frontend/templates/application", ["exports"], function (exports) {
  ...
  exports.default = Ember.HTMLBars.template({ "id": "2cYIeCr+", "block": "{\"symbols\":[],\"statements\":[[1,[18,\"welcome-page\"],false],[0,\"\\n\"],[0,\"\\n\"],[1,[18,\"outlet\"],false]],\"hasEval\":false}", "meta": { "moduleName": "pathway-viz-frontend/templates/application.hbs" } });
});
...
if (!runningTests) {
  require("pathway-viz-frontend/app")["default"].create({"name":"pathway-viz-frontend","version":"0.0.0+"});
}
